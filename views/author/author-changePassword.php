...
$this->title = 'Author Edit Password Page';
?>
...
<?php $form = Form::begin('', "post") ?>
    ...
    <div class="mt-3">
        <button class="btn btn-primary" onclick="window.location.href='/author/author-editDetails?id=<?php echo $_SESSION['user']?> '">Go Back</button>
    </div>
